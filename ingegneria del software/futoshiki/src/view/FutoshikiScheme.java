...
import model.ConstrainedMatrixScheme;
...
public class FutoshikiScheme {
	...
	public FutoshikiScheme(int dimension,Controller c, Point p){
		...
		this.weight=700;
		this.height=northPanelHeight+centralPanelHeight+southPanelHeight;
		this.c=c;
		...
		previous.setFont(new Font("Arial Black", Font.PLAIN, 12));
		...
		next.setName("next");
		next.setFont(new Font("Arial Black", Font.PLAIN, 12));
	...
	private class ButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			else if(name.equals("<")) c.setConstraint(Constraint.LESSER,0);
			else if(name.equals(">")) c.setConstraint(Constraint.GREATER,0);
			else if(name.equals("^")) c.setConstraint(Constraint.LESSER,1);
