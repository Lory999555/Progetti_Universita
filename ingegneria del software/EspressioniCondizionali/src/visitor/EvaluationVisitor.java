...
public class EvaluationVisitor implements Visitor {
	...
	public void visit(Div c) {
		...
		int op2 = operation;
		if (op2 == 0)
			throw new IllegalArgumentException(" ERRORE Divisione per 0 nel calcolo della divisione");
		operation = op1 / op2;
	}
	...
	public void visit(Rem c) {
		...
		int op2 = operation;
		if (op2 == 0)
			throw new IllegalArgumentException("ERRORE Divisione per 0 nel calcolo del resto");
		operation = op1 % op2;
	}
